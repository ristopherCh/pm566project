...
The maps highlight a few areas (the southeastern US) where COVID-19 and deaths due to overdose seem to correlate, as well as contrasting areas (the northern midwest and great plains states)
...
To investigate this possibility, monthly unemployment data in the 50 US states is shown:
...
The upward lurch in unemployment numbers displayed above suggests a devastating disruption in the lives of those experiencing unemployment, and the entire US society. This visualization also shows that some states experienced economic shutdown unemployment far worse than others - Hawaii and Nevada, for example, where tourism makes up a large sector of the economy.
