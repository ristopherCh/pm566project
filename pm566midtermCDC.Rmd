...
(It must be mentioned that no data regarding specific drug types is available for the years of 2016 and 2017. I'm searching for a way to fill in this data)
...
ggplot(drugs_usa2_2018, aes(x = date, y = deaths, color = indicator)) +
  geom_line() +
  theme(legend.title = element_text(size = 8), legend.text = element_text(size = 7)) +
  labs(title = "Overdose deaths by drug category, 2018-2021", x = "Date", y = "Monthly deaths by drug category", subtitle = "Source: data.cdc.gov API")
```
...
ggplot(drugs_usa3_2018, aes(x = date, y = deaths, color = indicator)) +
  ...
  labs(x = "Date", y = "Monthly deaths by drug category", title = "Opioid contribution to total overdose deaths, 2018-2021", subtitle = "Source: data.cdc.gov API") +
...
ggplot(drugs_usa2, aes(x = date, y = deaths, color = indicator)) +
  ...
  labs(title = "OD deaths from prominent drug categories, 2015-2021", x = "Date", y = "Monthly deaths", subtitle = "Source: data.cdc.gov API") +
  scale_x_date(date_breaks = "year",  date_labels = "%Y") +
  scale_color_npg()
```
...
ggplot(od_deaths, aes(x = date, y = deaths, color = state_name)) +
  geom_line() +
  labs(title = "Total monthly deaths by overdose, by state", x = "Date", y = "Monthly overdose deaths", subtitle = "Source: data.cdc.gov API") +
  theme(legend.title = element_text(size = 5), legend.text = element_text(size = 5))
...
ggplot(od_deaths, aes(x = date, y = deathspop, color = state_name)) +
  geom_line(show.legend = FALSE) +
  labs(title = "Monthly deaths by overdose, by % of state pop", x = "Date", y = "Monthly overdose deaths, by % of state pop.", subtitle = "Source: data.cdc.gov API")
...
ggplot(covid_od0320, aes(x = case_perc, y = perc_inc)) +
  geom_point() +
  geom_smooth() +
...
ggplot(covid_od20201B, aes(x = death_perc, y = deathspop)) +
  geom_point() +
  geom_smooth() +
...
These visualization indicates that there is either no relation between the two factors, or there is even a negative correlation. 
