...
Retrieving indicators from The World Bank API
...
WBindicators <- content(WBindicatorsquery, "parsed")

WBindicators <- as_list(WBindicators)

WBindicators2 <- lapply(WBindicators$data$data, function(d){
  data.frame(
